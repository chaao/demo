...
public class ReflectUtil {
	...
	public static Method getMethodByName(String methodName,Class parameterTypes, Class<?> clazz)
			throws Exception {
		Class<?> superClass = clazz;
		Method method = null;
	...
	public static void main(String[] args) {
		System.out.println(Arrays.asList(getMethodParamNames(ReflectUtil.class
				.getMethods()[6])));
